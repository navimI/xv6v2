...
00000000 <.text>:
  ...
  53:	ff 36                	push   (%esi)
  55:	e8 4a 02 00 00       	call   0x2a4
  5a:	83 c4 10             	add    $0x10,%esp
  5d:	85 c0                	test   %eax,%eax
  5f:	79 e2                	jns    0x43
  61:	83 ec 04             	sub    $0x4,%esp
  64:	ff 36                	push   (%esi)
  66:	68 5f 06 00 00       	push   $0x65f
  6b:	6a 02                	push   $0x2
 ...
 342:	0f b6 92 dc 06 00 00 	movzbl 0x6dc(%edx),%edx
 ...
 40f:	ff 24 85 84 06 00 00 	jmp    *0x684(,%eax,4)
 ...
 474:	75 15                	jne    0x48b
 476:	be 7b 06 00 00       	mov    $0x67b,%esi
 47b:	eb 0e                	jmp    0x48b
 ...
 507:	a1 88 09 00 00       	mov    0x988,%eax
 50c:	eb 02                	jmp    0x510
 ...
 545:	a3 88 09 00 00       	mov    %eax,0x988
 54a:	5b                   	pop    %ebx
 54b:	5e                   	pop    %esi
 54c:	5f                   	pop    %edi
 54d:	5d                   	pop    %ebp
 ...
 5a7:	a1 88 09 00 00       	mov    0x988,%eax
 ...
 5d2:	8b 0d 88 09 00 00    	mov    0x988,%ecx
 5d8:	85 c9                	test   %ecx,%ecx
 5da:	74 04                	je     0x5e0
 5dc:	8b 01                	mov    (%ecx),%eax
 5de:	eb 4b                	jmp    0x62b
 5e0:	c7 05 88 09 00 00 8c 	movl   $0x98c,0x988
 5e7:	09 00 00 
 5ea:	c7 05 8c 09 00 00 8c 	movl   $0x98c,0x98c
 5f1:	09 00 00 
 5f4:	c7 05 90 09 00 00 00 	movl   $0x0,0x990
 5fb:	00 00 00 
 5fe:	b9 8c 09 00 00       	mov    $0x98c,%ecx
 603:	eb d7                	jmp    0x5dc
 605:	74 1a                	je     0x621
 ...
 612:	89 0d 88 09 00 00    	mov    %ecx,0x988
 ...
 630:	73 d3                	jae    0x605
 632:	39 05 88 09 00 00    	cmp    %eax,0x988
 638:	75 ed                	jne    0x627
